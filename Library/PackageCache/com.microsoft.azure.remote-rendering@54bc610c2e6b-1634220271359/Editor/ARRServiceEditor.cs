...
public class ARRServiceEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        m_RefreshRate = serializedObject.FindProperty("RefreshSessionTimeInSeconds");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(m_RefreshRate, new GUIContent("Refresh Session Info Rate", m_RefreshRate.tooltip));
