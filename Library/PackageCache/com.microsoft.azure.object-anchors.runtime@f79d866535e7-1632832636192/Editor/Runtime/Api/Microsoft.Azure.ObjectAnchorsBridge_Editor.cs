...
namespace Microsoft.Azure.ObjectAnchors
{
    ...
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_instance_try_get_current_state(IntPtr handle, out ObjectInstanceStateNullable result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_load_object_model_async(IntPtr handle, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex=2)] byte[] buffer, int buffer_count, out IntPtr result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
    ...
    class IList_ObjectSearchArea : BasePrivateList<ObjectSearchArea>
    {
        ...
        protected override ObjectSearchArea InternalGetItem(int index)
        {
            ...
            result_object = (result_handle != IntPtr.Zero) ? new Microsoft.Azure.ObjectAnchors.ObjectSearchArea(result_handle, transfer:true) : null;
    ...
    public partial class AccountInformation
    {
        ...
        internal AccountInformation(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
    ...
    /// </summary>
    public partial class ObjectAnchorsSession
    {
        internal IntPtr handle;

        internal ObjectAnchorsSession(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
    ...
    /// </summary>
    public partial class ObjectInstanceChangedEventArgs : EventArgs
    {
        internal IntPtr handle;
    ...
    public partial class ObjectInstance : IDisposable, ICachedObject
    {
        ...
        {
            ObjectInstanceStateNullable result;
        ...
        internal static Microsoft.Azure.ObjectAnchors.ObjectInstance GetInstance(ulong cookie)
        ...
        private static ulong ConvertHandleToCookie(IntPtr handle)
        {
    ...
    /// </summary>
    public partial class ObjectModel : IDisposable
    {
        internal IntPtr handle;
    ...
    /// </summary>
    public partial class ObjectObserver : IDisposable
    {
        internal IntPtr handle;
        ...
        /// </param>
        public async System.Threading.Tasks.Task<Microsoft.Azure.ObjectAnchors.ObjectModel> LoadObjectModelAsync(byte[] buffer)
        {
            return await Task.Run(() =>
            {
                IntPtr result_handle;
    ...
    /// </summary>
    public partial class ObjectQuery : IDisposable
    {
        internal IntPtr handle;

        internal ObjectQuery(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
    ...
    /// </summary>
    public partial class ObjectSearchArea
    {
        internal IntPtr handle;

        internal ObjectSearchArea(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
...
namespace Microsoft.Azure.ObjectAnchors.Diagnostics
{
    ...
    /// </summary>
    public partial class ObjectDiagnosticsSession
    {
        internal IntPtr handle;

        internal ObjectDiagnosticsSession(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
